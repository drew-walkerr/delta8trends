...
tweets_per_day <- ggplot(d8_tweets_by_date_with_major_accounts, aes(day, tweets_per_day)) +
  geom_line(aes(color=`Tweet Source`,linetype= `Tweet Source`))+
...
#likes per day graph
likes_per_day <- ggplot(d8_tweets_by_date_with_major_accounts, aes(day, likes_per_day)) +
   geom_line(aes(color=`Tweet Source`,linetype= `Tweet Source`))+
...
retweets_per_day <- ggplot(d8_tweets_by_date_with_major_accounts, aes(day, retweets_per_day)) +
  geom_line(aes(color=`Tweet Source`,linetype= `Tweet Source`))+
  labs(y = "RTs, quotes, or replies per Day", title = "#Delta8 Retweets, quotes, or replies per day")+
  scale_x_date(date_breaks = "6 months", date_labels = "%b-%y")+
    theme_classic()+ 
  theme(axis.title.x=element_blank())
retweets_per_day
...
quotes_per_day <- ggplot(d8_tweets_by_date_with_major_accounts, aes(day, quotes_per_day)) +
   geom_line(aes(color=`Tweet Source`,linetype= `Tweet Source`))+
...
replies_per_day <- ggplot(d8_tweets_by_date_with_major_accounts, aes(day, replies_per_day)) +
   geom_line(aes(color=`Tweet Source`,linetype= `Tweet Source`))+
