...
hashtag_delta8_tweets_jan_2020 <-  get_all_tweets(
  ...
  end_tweets = "2021-08-13T00:00:00Z",
...
sentiment_per_day_plot <- ggplot(sentiment_syuzhet_by_day, aes(day, sentiment_avg_day)) +
  ...
  geom_smooth(method = "loess", se = FALSE) +
  labs(x = "January 1, 2020 to August 3, 2021", y = "Weighted Average Syuzhet Sentiment per Day", title = "Change in sentiment in Tweets mentioning #delta8")+
  scale_x_date(date_breaks = "2 months", date_labels = "%b-%y")+
    theme_classic()
...
ggplot(sentiment_syuzhet$syuzhet_sentiment)
#test
```
